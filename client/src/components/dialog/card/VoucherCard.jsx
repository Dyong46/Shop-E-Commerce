  ...
  return (
    <div className="flex flex-col my-6">
      ...
      {/* <div className="text-orange text-sm flex">
        <div className=" mx-1">
          <svg fill="orange" xmlns="http://www.w3.org/2000/svg" width="17" height="17" viewBox="0 0 32 32" id="error">
            <path d="M16 0C7.164 0 0 7.164 0 16s7.164 16 16 16 16-7.164 16-16S24.836 0 16 0zm0 30C8.28 30 2 23.72 2 16S8.28 2 16 2s14 6.28 14 14-6.28 14-14 14zm0-24a2 2 0 0 0-2 2v10a2 2 0 0 0 4 0V8a2 2 0 0 0-2-2zm-2 17.968a2 2 1080 1 0 4 0 2 2 1080 1 0-4 0z"></path>
          </svg>
        </div>
