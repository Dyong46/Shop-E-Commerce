    ...
    <div>
      <div className="flex justify-around bg-header text-white">
        ...
        <div className="my-2 flex">
          ...
          <svg width={18} viewBox="0 0 16 16" className="shopee-svg-icon icon-help-center">
          ...
          <img
            className="mt-1 ml-2 w-5 h-5 rounded-3xl"
            src="https://down-vn.img.susercontent.com/file/193621f7a82c9b98a21e6b91b61b9318_tn"
          ></img>
      ...
      <div className="flex justify-around mb-8">
        ...
        <div className="mt-8 flex">
          <input className="input-color px-2" type="text" name="" id="" placeholder="Thử vận may hôm nay" />
          <div className="bg-btn px-5 h-10 cursor-pointer">
            <svg fill="white" viewBox="1 -8 20 35" width={21} className="shopee-svg-icon">
